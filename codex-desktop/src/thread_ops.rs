...
pub async fn queue_list(
    ...
    let response: ThreadQueueListResponse = bridge
        .request_as(ClientRequest::ThreadQueueList {
            request_id: bridge.next_request_id(),
...
pub async fn background_terminals_list(
    ...
    let response: ThreadBackgroundTerminalsListResponse = bridge
        .request_as(ClientRequest::ThreadBackgroundTerminalsList {
            request_id: bridge.next_request_id(),
